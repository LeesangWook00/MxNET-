...
* **핵심 역할** : 공동 연구 및 보고서 작성, 선형회귀 알고리즘 구현 및 성능 비교 분석 하였습니다
* **개발 환경** : Python, PyTorch, MxNET Framework

#### **⚙️ 주요 분석 내용**
* **객체지향 디자인 패턴 적용:** Module, DataModule, Trainer 등 독립적인 클래스 설계를 통한 기계학습 파이프라인 구조 분석 하였습니다
* **알고리즘 구현 비교:**
...
* 복잡한 인공지능 모델(영상, 언어 등)을 다루기 위한 **기계학습의 기초 파이프라인(Data-Model-Loss-Optimization) 전 과정을 완벽히 이해**함 
